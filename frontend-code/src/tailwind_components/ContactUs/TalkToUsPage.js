...
const TalkToUsPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Talk To Us | StudyStreak.in</title>
        <meta
          name="description"
          content="Get in touch with the StudyStreak.in team for support, inquiries, and more information about our international test preparation courses."
        />
        <meta
          name="keywords"
          content="Contact StudyStreak, StudyStreak Support, international education, IELTS help, TOEFL guidance, PTE support, study abroad assistance"
        />
        <meta name="author" content="StudyStreak.in" />

        {/* Canonical URL */}
        <link rel="canonical" href="https://www.studystreak.in/talk-to-us" />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://www.studystreak.in/talk-to-us"
        />
        <meta property="og:title" content="Talk To Us | StudyStreak.in" />
        <meta
        ...
        <meta
          ...
          content="https://www.studystreak.in/talk-to-us"
        />
        <meta name="twitter:title" content="Talk To Us | StudyStreak.in" />
        <meta
