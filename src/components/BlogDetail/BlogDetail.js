...
import blog12 from "../../img/blog/blog_12.png";
import blog13 from "../../img/blog/blog_13.png";
import blog14 from "../../img/blog/blog_14.png";
import blog15 from "../../img/blog/blog_15.png";
import blog16 from "../../img/blog/blog_16.png";
import blog17 from "../../img/blog/blog_17.png";
import blog18 from "../../img/blog/blog_18.png";
              ...
              <div className="row">
                    ...
                    <div className="blog__details__content">
                      ...
                      <div className="blockquate__wraper" data-aos="fade-up">
                        <div className="blockquate__content">
                          ...
                          <Link>John Mirnsdo</Link>
                        </div>
                        <div className="blockquate__img">
                          <img src={blog22} alt="img" />
                        </div>
                      </div>
                      <div
                        className="blog__details__heading"
                      ...
                      <div className="row blog__details__margin">
                        ...
                        >
                          <div className="blog__details__img__2">
                            <img src={blog23} alt="blog" />
                          </div>
                        </div>
                        <div className="col-xl-8 col-lg-8 col-md-8">
                          <div
                            className="blog__details__heading__2"
                            data-aos="fade-up"
                          >
                ...
                <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                  ...
                  >
                    ...
                    <form action="#">
                      <div className="blogsudebar__input__area">
                        <input
                          type="text"
                          name="search"
                          placeholder="Search product"
                        />
                        <button className="blogsidebar__input__icon">
                      ...
                      <li>
                        ...
                        <div className="recent__text">
                          <div className="recent__date">
                            <Link>23 December 2023</Link>
                          </div>
                          <h6>
                            <Link href="blog-deetails.html">
