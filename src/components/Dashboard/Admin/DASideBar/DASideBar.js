        ...
        <div className="dashboard__inner sticky-top">
          ...
          <div className="dashboard__nav">
            <ul>
              ...
              <li>
                <Link
                  className={location === "/admin-package" ? "active" : ""}
                  to="/admin-package"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <Link
                  className={location === "/admin-course" ? "active" : ""}
                  to="/admin-course"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <Link
                  className={location === "/admin-exam" ? "active" : ""}
                  to="/admin-exam"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <Link
                  className={location === "/admin-liveClass" ? "active" : ""}
                  to="/admin-liveClass"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <Link
                  className={location === "/admin-batch" ? "active" : ""}
                  to="/admin-batch"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
