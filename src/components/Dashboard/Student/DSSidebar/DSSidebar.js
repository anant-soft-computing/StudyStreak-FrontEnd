        ...
        <div className="dashboard__nav">
          <ul>
            ...
            <li>
              <Link
                className={
                  location === "/dashboard/student-message" ? "active" : ""
                }
            ...
            <li>
              <Link
                className={
                  location === "/dashboard/student-enrolled-courses"
                    ? "active"
                    : ""
                }
            ...
            <li>
              <Link
                className={
                  location === "/dashboard/student-wishlist" ? "active" : ""
                }
            ...
            <li>
              <Link
                className={
                  location === "/dashboard/student-reviews" ? "active" : ""
                }
            ...
            <li>
              <Link
                className={
                  location === "/dashboard/student-my-quiz-attempts"
                    ? "active"
                    : ""
                }
                to="/dashboard/student-my-quiz-attempts"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
            ...
            <li>
              <Link
                className={
                  location === "/dashboard/student-assignments" ? "active" : ""
                }
