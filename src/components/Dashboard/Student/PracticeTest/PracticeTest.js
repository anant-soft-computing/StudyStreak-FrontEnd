...
const SectionTest = () => {
  ...
  const readingData = practiceTestData?.filter(
    (item) => item.exam_type === "Reading"
  );

  const writingData = practiceTestData?.filter(
    (item) => item.exam_type === "Writing"
  );

  const listeningData = practiceTestData?.filter(
    (item) => item.exam_type === "Listening"
  );

  const speakingData = practiceTestData?.filter(
